...
$string['remotegroupcodefield_desc'] = 'The name of the field in the remote table which contains the group code.';
$string['remotegroupnamefield'] = 'Remote Group Name field';
$string['remotegroupnamefield_desc'] = 'The name of the field in the remote table which contains the group name.';
